...
### blas-fp4gemm
  Scaled matrix-matrix multiplication in a 4-bit microscaling floating-point format
...
### blas-groupgemm (triton)
  Grouped general matrix-matrix multiplications using cuBLASLt, hipBLASLt, and oneDNN 

### blas-mxfp6gemm (cuda)
  Scaled matrix-matrix multiplication in a 6-bit microscaling floating-point format

### blas-mxfp8gemm (cuda)
  Scaled matrix-matrix multiplication in a 8-bit microscaling floating-point format
...
### blockScan (cuda)
  Block scans from the CUB's collective primitives (https://github.com/NVIDIA/cub)
...
### dp4a (cuda)
  Four-way unsigned and signed 8-bit dot product with integer accumulate (https://github.com/ggml-org/llama.cpp)
...
### hadamard (cuda)
  Fast Hadamard transformation (https://github.com/Dao-AILab/fast-hadamard-transform)
...
### jacobian (cuda)
  Full Jacobian of a batched softmax (https://docs.pytorch.org/tutorials/intermediate/jacobians_hessians.html)
...
### silu (cuda)
  The Swish activate functions (https://github.com/clu0/unet.cu)
...
### ssm (cuda)
  Selective scan mechanism (https://github.com/vllm-project/vllm)
