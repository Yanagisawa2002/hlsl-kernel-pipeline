...
standalone .NET application (candidate compilation/execution remain unverified
after the frozen restore failure). It consumes the existing `CrowdCpuRenderer` through
