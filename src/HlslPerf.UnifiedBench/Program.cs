...
{
    schema = "hlslperf.unified-diagnostic.v1", developmentOnly = true, pid = Environment.ProcessId,
    startedUtc = started, recordedUtc = DateTimeOffset.UtcNow, fixture, fixtureMilliseconds,
    device = tuner.DescribeDevice("6_6"), compilation = executor.CompilationEvidence, results
